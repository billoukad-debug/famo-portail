// Session staff : cookie HttpOnly signe (HMAC), 8 h.
// TEMPORAIRE (demande produit) : fallback STAFF_CODE = famo2026 si env absente.
const crypto = require("crypto");
const CODE = process.env.STAFF_CODE || "famo2026";
