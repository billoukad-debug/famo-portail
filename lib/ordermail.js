...
function linesRow(rows, total) {
  ...
  const foot = '<tr><td colspan="2" align="right" style="padding:12px 10px 4px 10px;border-top:2px solid #191512;font-size:15px;font-weight:bold;color:#191512;' + FONT + '">Totaal</td>' +
